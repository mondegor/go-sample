...
- К обработчику `health` привязаны пробы БД, redis, Minio;
...
- Перенесён `entity.Money` -> `measure.Money`;
...
- Изменена структура документации;
...
## 2024-06-26
### Changed
- Переработана структура папок с компонентами системы;
