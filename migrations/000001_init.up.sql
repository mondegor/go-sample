...
ALTER SEQUENCE sample_catalog.categories_category_id_seq RESTART WITH 9;
...
CREATE TABLE sample_catalog.products (
    ...
    created_at timestamp NOT NULL DEFAULT now(),
    updated_at timestamp NULL,
    category_id int4 NOT NULL CONSTRAINT fk_products_category_id REFERENCES sample_catalog.categories (category_id),
