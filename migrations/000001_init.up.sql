...
CREATE SCHEMA gscatalog AUTHORIZATION user_pg;

-- --------------------------------------------------------------------------------------------------

CREATE TABLE gscatalog.categories (
...
INSERT INTO gscatalog.categories (category_id, tag_version, created_at, updated_at, category_caption, image_meta, category_status)
VALUES
...
ALTER SEQUENCE gscatalog.categories_category_id_seq RESTART WITH 9;

-- --------------------------------------------------------------------------------------------------

CREATE TABLE gscatalog.trademarks (
...
INSERT INTO gscatalog.trademarks (trademark_id, tag_version, created_at, updated_at, trademark_caption, trademark_status)
VALUES
...
ALTER SEQUENCE gscatalog.trademarks_trademark_id_seq RESTART WITH 9;

-- --------------------------------------------------------------------------------------------------

CREATE TABLE gscatalog.products (
    product_id int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY CONSTRAINT PK_products PRIMARY KEY,
    tag_version int4 NOT NULL DEFAULT 1 CHECK(tag_version > 0),
    created_at timestamp NOT NULL DEFAULT now(),
    updated_at timestamp NULL,
    category_id int4 NOT NULL CONSTRAINT FK_products_category_id REFERENCES gscatalog.categories (category_id),
    ...
    trademark_id int4 NOT NULL CONSTRAINT FK_products_trademark_id REFERENCES gscatalog.trademarks (trademark_id),
...
INSERT INTO gscatalog.products (product_id, tag_version, created_at, updated_at, category_id, product_article, product_caption, trademark_id, product_price, product_status, prev_field_id, next_field_id, order_field)
VALUES
...
CREATE INDEX IX_products_category_id_order_field ON gscatalog.products (category_id, order_field);

ALTER SEQUENCE gscatalog.products_product_id_seq RESTART WITH 9;
