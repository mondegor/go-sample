...
mrcmd_func_openapi_build_pub_file_station() {
  ...
  local moduleDir="${sectionDir}/file-station"
...
#  )
  ...
  OPENAPI_COMPONENTS_PARAMETERS=(
    ...
    "${moduleDir}/components-parameters.yaml"
  )
  ...
  OPENAPI_COMPONENTS_SCHEMAS=(
    ...
    "${moduleDir}/components-schemas.yaml"
  )
  ...
  OPENAPI_COMPONENTS_RESPONSES=(
    ...
    "${moduleDir}/components-responses.yaml"
  )
