...
type (
	CategoryUseCase interface {
		...
		GetItem(ctx context.Context, itemID mrtype.KeyInt32) (entity.Category, error)
		Create(ctx context.Context, item entity.Category) (mrtype.KeyInt32, error)
	...
	CategoryStorage interface {
		...
		Insert(ctx context.Context, row entity.Category) (mrtype.KeyInt32, error)
